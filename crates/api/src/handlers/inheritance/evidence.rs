...
use crate::db::queries::evidence::{
    fetch_audit_event_hashes, fetch_claim_attachments, fetch_release_record,
};
...
pub async fn create_evidence_package(
    ...
    let evidence_bytes = canonicalize(&evidence).map_err(|_| {
