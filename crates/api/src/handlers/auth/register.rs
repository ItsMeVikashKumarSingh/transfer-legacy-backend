...
pub async fn register_init(
    ...
    headers: HeaderMap,
    Json(payload): Json<RegisterInitRequest>,
) -> Result<Json<crate::errors::SuccessEnvelope<RegisterInitResponse>>, ApiError> {
    ...
    Ok(success(&request_id, RegisterInitResponse {
        session_id,
...
pub async fn register_finish(
    ...
    insert_opaque_record(&mut tx, &row).await
        .map_err(|_| ApiError::app_with_request_id(transfer_legacy_shared_types::AppError::Internal, &request_id))?;
